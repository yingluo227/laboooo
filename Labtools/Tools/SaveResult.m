...
XlsData = ReadXls('Z:\Data\MOOG\Results\Result_PCall.xlsm',2,3);
                case 'Out-sync model'
                    XlsData = ReadXls('Z:\Data\MOOG\Results\Result_TQY_outSyncModel.xlsm',2,3);
            end
        else
            %             XlsData = ReadXls('Z:\Data\MOOG\Results\Result_LBY.xlsm',2,3);
%             XlsData = ReadXls('Z:\Data\MOOG\Results\Result_TQY.xlsm',2,3);
XlsData = ReadXls('Z:\Data\MOOG\Results\Result_PCall.xlsm',2,3);
% XlsData=ReadXls('Z:\Data\MOOG\Results\Result_allcontrol.xlsx',1,3);
        end
    end
    %}
...
%                             xlswrite1('Z:\Data\MOOG\Results\Result_LBY_syncModel.xlsm',toXls,2,range_name);  % Speed-up of xlswrite
                        ...
                        case 'Out-sync model'
                            xlswrite1('Z:\Data\MOOG\Results\Result_TQY_outSyncModel.xlsm',toXls,2,range_name);  % Speed-up of xlswrite
                    end
                else
...
xlswrite1('Z:\Data\MOOG\Results\Result_PCall.xlsm',toXls,2,range_name);  % Speed-up of xlswrite
% xlswrite1('Z:\Data\MOOG\Results\Result_allcontrol.xlsx',toXls,1,range_name);  % Speed-up of xlswrite
