...
for k = 1:length(unique_stimType)
    ...
    switch Protocol
        case DIRECTION_TUNING_3D
            ss = [str2, '_T'];
            saveas(20+k,['Z:\Data_analyses\Recording_data\',PSTH.monkey,'\3D_Tuning\Translation\' ss], 'emf');
        case ROTATION_TUNING_3D
            ss = [str2, '_R'];
            saveas(20+k,['Z:\Data_analyses\Recording_data\',PSTH.monkey,'\3D_Tuning\Rotation\' ss], 'emf');
    end
end
%}
...
for k = 1:length(unique_stimType)
    ...
    if Protocol == DIRECTION_TUNING_3D
        ss = [str3, '_T'];
                saveas(30+k,['Z:\Data_analyses\Recording_data\',PSTH.monkey,'\3D_Tuning\Translation\' ss], 'emf');
%         saveas(30+k,['Z:\LBY\Recording data\Position cell\' ss], 'emf');
    elseif Protocol == ROTATION_TUNING_3D
        ss = [str3, '_R'];
                saveas(30+k,['Z:\Data_analyses\Recording_data\',PSTH.monkey,'\3D_Tuning\Rotation\' ss], 'emf');
%         saveas(30+k,['Z:\LBY\Recording data\Position cell\' ss], 'emf');
    end
